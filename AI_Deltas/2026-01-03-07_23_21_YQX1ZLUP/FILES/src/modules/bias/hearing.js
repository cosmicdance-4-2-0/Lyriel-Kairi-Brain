...
- File: src/modules/bias/hearing.js
...
- Intent:
  - Provide a bounded Hearing bias field that decays over time and modulates Path B probability only.
- Constraints:
  - Clamp bias injections and path probabilities to baseline-safe ranges.
  - Keep implementation dependency-free and grid-size aware.
- Notes:
  - Uses a Gaussian-like kernel for spatial injection; defaults align with baseline suggestions.
*/
