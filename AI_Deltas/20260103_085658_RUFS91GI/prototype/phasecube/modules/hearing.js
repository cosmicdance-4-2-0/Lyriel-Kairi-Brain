...
Purpose: Maintain a decaying, bounded Hearing bias field for the static web bundle and modulate Path B probability only.
Sources:
- src/modules/bias/hearing.js
Notes:
- Kernel mapping and clamps mirror baseline behavior; only provenance and relative placement changed.
*/
