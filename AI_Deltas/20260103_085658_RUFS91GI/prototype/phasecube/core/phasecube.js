...
Purpose: Baseline PhaseCube runner for the static web bundle with seeded determinism and optional bias coupling.
Sources:
- src/core/phasecube/index.js
Notes:
- Topology, clamps, and probabilities match the baseline; only imports and provenance differ from upstream.
*/
