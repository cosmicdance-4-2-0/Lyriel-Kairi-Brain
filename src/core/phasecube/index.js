...
- File: src/core/phasecube/index.js
...
- Intent:
  - Implement a baseline-conformant PhaseCube runner with seeded determinism and bias-aware Path B modulation.
- Constraints:
  - Preserve boundedness, toroidal topology, and 6-connected neighborhood sampling.
  - Keep core free of DOM/web dependencies; typed arrays only.
- Notes:
  - Bias modulation is optional and clamps to pB_min/pB_max per Hearing baseline.
*/
